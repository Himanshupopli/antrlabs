          ...
          >
            ...
            {activeTab === "noor" && (
              <div className="space-y-24 max-w-4xl mx-auto px-6">
                ...
                {/* Clean filmstrip graphic */}
                <div className="py-4">
                  <span className="font-mono text-[9px] text-neutral-500 uppercase tracking-widest block text-center mb-4">
                    CINEMATIC VISUAL STORYTELLING (ART DIRECTION)
                  </span>
                  <div className="grid grid-cols-3 gap-2 max-w-md mx-auto aspect-[16/7] items-center">
                    <div className="bg-neutral-900 border border-white/5 aspect-video flex flex-col justify-between p-2 relative overflow-hidden text-[8px] font-mono text-neutral-500">
                      <span>FRAME_01</span>
                      <div className="w-6 h-6 rounded-full border border-white/10 self-center"></div>
                      <span className="text-right">WARM TONALITY</span>
                    </div>
                    <div className="bg-neutral-900 border border-white/5 aspect-video flex flex-col justify-between p-2 relative overflow-hidden text-[8px] font-mono text-neutral-500">
                      <span>FRAME_02</span>
                      <div className="w-8 h-4 bg-[#FF3F00]/10 self-center rounded-sm border border-[#FF3F00]/20"></div>
                      <span className="text-right">SUBTLE TEXTURE</span>
                    </div>
                    <div className="bg-neutral-900 border border-white/5 aspect-video flex flex-col justify-between p-2 relative overflow-hidden text-[8px] font-mono text-neutral-500">
                      <span>FRAME_03</span>
                      <div className="h-6 w-[2px] bg-white/20 self-center"></div>
                      <span className="text-right">NARRATIVE COHERENCE</span>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === "packaging" && (
              <div className="space-y-24 max-w-4xl mx-auto px-6">
                ...
                <div className="space-y-6 text-center max-w-3xl mx-auto">
                  ...
                  {/* Flow representation */}
                  <div className="pt-6 font-mono text-[10px] text-neutral-500 uppercase tracking-widest flex justify-center items-center gap-2 sm:gap-4 flex-wrap">
                    <span>FIRST DRAFT</span>
                    <span>→</span>
                    <span className="text-[#FF3F00] font-bold">RETAIL CRITIQUE</span>
                    <span>→</span>
                ...
                <div className="space-y-12">
                  ...
                  {/* High contrast structured list for hierarchy */}
                  <div className="max-w-md mx-auto divide-y divide-white/10 font-mono text-xs tracking-wider">
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">01 • BENEFITS</span>
                      <span className="text-white text-right">Quick Scan Callouts</span>
                    </div>
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">02 • USAGE</span>
                      <span className="text-white text-right">Intuitive Steps</span>
                    </div>
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">03 • TECH SPECS</span>
                      <span className="text-white text-right">Structured Metrics</span>
                    </div>
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">04 • ICONOGRAPHY</span>
                      <span className="text-white text-right">Repeatable Glyphs</span>
                    </div>
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">05 • ANATOMY</span>
                      <span className="text-white text-right">Precision Illustrations</span>
                    </div>
                    <div className="py-3 flex justify-between">
                      <span className="text-neutral-500 uppercase">06 • BRAND WORLD</span>
                      <span className="text-white text-right">Cohesive Visual Systems</span>
                    </div>
                  </div>
                </div>
