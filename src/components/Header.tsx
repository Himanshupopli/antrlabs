      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <a
            ...
            className="group flex items-center gap-3 font-display hover:opacity-90 transition-opacity"
          >
            <span className="text-xl md:text-2xl font-bold tracking-[0.2em] text-white">ANTR</span>
            <span className="w-1.5 h-6 bg-[#FF4500] block"></span>
          </a>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex justify-between items-center w-full">
              ...
              >
                <span className="text-xl font-bold tracking-[0.2em] text-white">ANTR</span>
                <span className="w-1 h-5 bg-[#FF4500] block"></span>
              </a>
              <button
