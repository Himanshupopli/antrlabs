        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          >
            ...
            <img
              ...
              className="h-6 md:h-8 w-auto object-contain shrink-0 max-w-none aspect-auto select-none"
            />
            ...
            <div className="flex justify-between items-center w-full">
              ...
              >
                <img
                  ...
                  alt="ANTR Logo"
                  referrerPolicy="no-referrer"
                  className="h-6 w-auto object-contain shrink-0 max-w-none aspect-auto select-none"
                />
              </a>
              <button
