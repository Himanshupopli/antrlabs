        ...
        <div className="max-w-3xl mx-auto px-6 space-y-24 mb-32 text-center">
          ...
          <div className="space-y-16 pt-6">
            ...
            <div className="space-y-8 max-w-2xl mx-auto p-6 bg-neutral-950/40 border border-neutral-900 rounded-2xl hover:border-white/10 transition-colors text-left">
              ...
              <div className="py-12 flex justify-center items-center bg-black rounded-xl border border-neutral-900 relative overflow-hidden group">
                <div className="absolute inset-0 bg-radial-gradient from-[#D4AF37]/5 to-transparent opacity-50"></div>
                <svg className="w-28 h-28 text-[#D4AF37] relative z-10 transition-transform duration-500 group-hover:scale-105" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  {/* Outer circle of sacred geometry */}
                  <circle cx="50" cy="50" r="45" stroke="currentColor" strokeWidth="1.2" strokeDasharray="2 2" opacity="0.4" />
                  {/* Nested geometric petals */}
                  <circle cx="50" cy="32" r="18" stroke="currentColor" strokeWidth="1" />
                  <circle cx="50" cy="68" r="18" stroke="currentColor" strokeWidth="1" />
                  <circle cx="32" cy="50" r="18" stroke="currentColor" strokeWidth="1" />
                  <circle cx="68" cy="50" r="18" stroke="currentColor" strokeWidth="1" />
                  {/* Central balance node */}
                  <circle cx="50" cy="50" r="5" fill="currentColor" />
                  <path d="M50 5 L50 95" stroke="currentColor" strokeWidth="0.5" opacity="0.3" />
                  <path d="M5 50 L95 50" stroke="currentColor" strokeWidth="0.5" opacity="0.3" />
                </svg>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto pt-4 text-left">
              <div className="aspect-[4/3] bg-neutral-950 border border-neutral-900 rounded-xl overflow-hidden relative group">
                <img 
                  src="https://res.cloudinary.com/brb2bqid/image/upload/v1783343483/Swaragya-images-26_smmtis.jpg"
                  alt="Swaragya Brand Philosophy & Spatial Geometry"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  referrerPolicy="no-referrer"
                  loading="lazy"
                />
              ...
              <div className="aspect-[4/3] bg-neutral-950 border border-neutral-900 rounded-xl overflow-hidden relative group">
                <img 
                  src="https://res.cloudinary.com/brb2bqid/image/upload/v1783343483/Swaragya-images-27_sytogp.jpg"
                  alt="Swaragya Brand Narrative & Consumer Story"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  referrerPolicy="no-referrer"
                  loading="lazy"
                />
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto text-left">
              ...
              <div className="flex flex-col bg-neutral-950 border border-neutral-900 rounded-2xl overflow-hidden group">
                <div className="aspect-square bg-black overflow-hidden relative flex items-center justify-center p-8 border-b border-neutral-900">
                  <div className="absolute inset-0 bg-radial-gradient from-[#D4AF37]/5 to-transparent opacity-50"></div>
                  <svg className="w-16 h-16 text-[#D4AF37] relative z-10 transition-transform duration-500 group-hover:scale-110" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="50" cy="50" r="45" stroke="currentColor" strokeWidth="1" strokeDasharray="2 2" opacity="0.4" />
                    <circle cx="50" cy="32" r="18" stroke="currentColor" strokeWidth="1" />
                    <circle cx="50" cy="68" r="18" stroke="currentColor" strokeWidth="1" />
                    <circle cx="32" cy="50" r="18" stroke="currentColor" strokeWidth="1" />
                    <circle cx="68" cy="50" r="18" stroke="currentColor" strokeWidth="1" />
