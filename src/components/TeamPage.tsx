...
export default function TeamPage({ onBackToHome, onNavigateToSection }: TeamPageProps) {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (!mobileNo.trim() || !email.trim() || !linkedin.trim()) {
          ...
          <div className="lg:col-span-8 space-y-20 md:space-y-24">
            {TEAM_MEMBERS.map((member, index) => (
              ...
              >
                ...
                <div className="w-64 sm:w-72 md:w-56 lg:w-64 aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-neutral-950 border border-neutral-800 flex-shrink-0 shadow-2xl">
                  <img
                    src={member.image}
                    alt={member.name}
                    loading="lazy"
