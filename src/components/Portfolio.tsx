          ...
          {visibleProjects.map((project, index) => (
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden bg-neutral-950 mb-6 border border-neutral-900 flex items-center justify-center">
                {/* Shark Tank sticker logo overlay for the first two cards */}
                {index < 2 && (
                ...
                {project.id === "sukham" ? (
                  <iframe
                    src="https://www.youtube-nocookie.com/embed/gXDhGaSyegM?autoplay=1&mute=1&loop=1&playlist=gXDhGaSyegM&controls=0&modestbranding=1&playsinline=1&rel=0&showinfo=0&iv_load_policy=3&disablekb=1&fs=0"
                  ...
                  <iframe
                    src="https://www.youtube-nocookie.com/embed/mwVPxoxvCEk?autoplay=1&mute=1&loop=1&playlist=mwVPxoxvCEk&controls=0&modestbranding=1&playsinline=1&rel=0&showinfo=0&iv_load_policy=3&disablekb=1&fs=0"
                    className="absolute w-[237%] h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-0 pointer-events-none bg-black"
                    allow="autoplay; encrypted-media"
