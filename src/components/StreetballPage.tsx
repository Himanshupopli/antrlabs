          ...
          <div className="pt-16 border-t border-white/10 space-y-16">
            ...
            <div className="space-y-12 text-center">
              ...
              <div className="space-y-4">
                ...
                <div className="w-full aspect-[16/9] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group max-w-4xl mx-auto shadow-2xl">
                  <img 
                    src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344939/process-_shooting_stars_gghczg.jpg"
            ...
            <div className="space-y-12 text-center pt-8">
              ...
              <div className="space-y-4">
                ...
                <div className="max-w-2xl mx-auto aspect-[4/3] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-2xl">
                  <img 
                    src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344935/final-logo_mbeejs.jpg"
            ...
            <div className="space-y-16 text-center pt-8">
              ...
              <div className="space-y-6">
                <div className="font-mono text-[10px] text-neutral-500 tracking-[0.2em] uppercase">
                  (Show final jerseys + exploration in a collage)
                </div>
                ...
                <div className="max-w-4xl mx-auto space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="aspect-[4/3] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-lg">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344937/jersey_explorations1_qzvx4g.jpg"
                    ...
                    <div className="aspect-[4/3] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-lg">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344936/jersey_explorations_2_gepeb7.jpg"
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="aspect-[3/4] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-md">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344934/final-jersey1_nxnpc6.jpg"
                    ...
                    <div className="aspect-[3/4] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-md">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344941/final_jersey_2_r9upmg.jpg"
                    ...
                    <div className="aspect-[3/4] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-md">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344942/final_jersey_3_e5na3q.jpg"
                    ...
                    <div className="aspect-[3/4] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-md">
                      <img 
                        src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344933/final_jersey_4_bnjltf.jpg"
              ...
              <div className="space-y-6 pt-8">
                <div className="font-mono text-[10px] text-neutral-500 tracking-[0.2em] uppercase">
                  (The show other collateral in a new collage)
                </div>
          ...
          <div className="pt-16 border-t border-white/10 space-y-16">
            ...
            <div className="space-y-12 text-center">
              ...
              <div className="space-y-4">
                ...
                <div className="max-w-2xl mx-auto aspect-[16/10] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group shadow-2xl">
                  <img 
                    src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344940/wolfer_x_logo_n6uutd.jpg"
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                    ...
                    <div className="bg-[#0D0D0D] border border-white/10 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-white/20 transition-colors">
                      ...
                      <div className="aspect-square bg-black p-6 flex flex-col justify-between relative overflow-hidden group">
                        <div className="absolute inset-0 bg-radial-gradient from-neutral-900 to-black opacity-40"></div>
                        <div className="flex justify-between items-start z-10">
                          <span className="font-mono text-[9px] text-neutral-500 tracking-widest uppercase">ROSTER REVEAL</span>
                          <span className="font-mono text-[9px] text-white tracking-widest uppercase border border-white/20 px-1.5 py-0.5">NEW SIGNING</span>
                        </div>
                        
                        <div className="space-y-1 z-10">
                          <span className="font-display font-black text-2xl sm:text-3xl text-white tracking-tight uppercase leading-none block">
                            MEGHNA KAUR
                          </span>
                          <span className="font-mono text-[9px] text-[#FF4500] tracking-widest block font-bold">
                            OWNER & CHIEF STRATEGIST
                          </span>
                        </div>

                        <div className="flex justify-between items-end border-t border-white/10 pt-3 z-10">
                          <span className="font-mono text-[9px] text-neutral-400">POSITION: GUARD</span>
                          <span className="font-mono text-[9px] text-neutral-400">DELHI INC. SYSTEM</span>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#0D0D0D] border border-white/10 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-white/20 transition-colors">
                      ...
                      <div className="aspect-square bg-black p-6 flex flex-col justify-between relative overflow-hidden group">
                        <div className="flex justify-between items-start z-10">
                          <span className="font-mono text-[9px] text-[#FF4500] tracking-widest uppercase font-bold">MATCHDAY FINAL</span>
                          <span className="font-mono text-[9px] text-neutral-500 tracking-widest uppercase">SEASON 02</span>
                        </div>

                        <div className="flex items-center justify-between py-4 z-10">
                          <div className="text-center space-y-1">
                            <span className="font-display font-bold text-lg text-white block uppercase tracking-wide">DEL</span>
                            <span className="font-mono text-3xl font-black text-white block">84</span>
                          </div>
                          <div className="text-neutral-700 font-mono text-[10px] tracking-widest font-bold">VS</div>
                          <div className="text-center space-y-1">
                            <span className="font-display font-bold text-lg text-neutral-500 block uppercase tracking-wide">STS</span>
                            <span className="font-mono text-3xl font-black text-neutral-500 block">79</span>
                          </div>
                        </div>

                        <div className="flex justify-between items-end border-t border-white/10 pt-3 z-10">
                          <span className="font-mono text-[9px] text-[#FF4500] font-bold">DELHI INC. WIN</span>
                          <span className="font-mono text-[9px] text-neutral-400">FULL-TIME REPORT</span>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#0D0D0D] border border-white/10 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-white/20 transition-colors">
                      ...
                      <div className="aspect-square bg-black p-6 flex flex-col justify-between relative overflow-hidden group">
                        <div className="flex justify-between items-start z-10">
                          <span className="font-mono text-[9px] text-neutral-500 tracking-widest uppercase">SPONSOR INTERNALS</span>
                          <span className="font-mono text-[9px] text-neutral-500 tracking-widest uppercase">PARTNERSHIP</span>
                        </div>

                        <div className="space-y-2 py-4 z-10">
                          <span className="font-mono text-[8px] tracking-widest text-[#FF4500] uppercase block font-bold">PRESENTING SPONSOR</span>
                          <div className="py-2 border-y border-white/10 flex items-center justify-center bg-neutral-950 rounded">
                            <span className="font-display font-black text-xl text-white tracking-widest uppercase">WOLFER</span>
                          </div>
                        </div>

                        <div className="flex justify-between items-end border-t border-white/10 pt-3 z-10">
                          <span className="font-mono text-[9px] text-neutral-400">COLLABORATOR</span>
                          <span className="font-mono text-[9px] text-neutral-400">DELHI INC. SYSTEM</span>
                        </div>
                      </div>
            ...
            <div className="space-y-12 text-center pt-8">
              ...
              <div className="space-y-4">
                ...
                <div className="w-full aspect-[16/9] bg-neutral-950 border border-white/5 rounded-2xl overflow-hidden relative group max-w-4xl mx-auto shadow-2xl">
                  <img 
                    src="https://res.cloudinary.com/brb2bqid/image/upload/v1783344938/last_pic_h6mih0.jpg"
                  ...
                  />
                  <div className="absolute bottom-4 left-4 bg-black/85 backdrop-blur-md px-3 py-1.5 border border-white/5 rounded text-[10px] font-mono tracking-widest text-neutral-400 uppercase select-none">
                    04 / DELHI INC. ON-COURT UNIFORM SHOWCASE & LAYOUTS
                  </div>
                </div>
              </div>
            </div>
