  ...
  return (
    <div className="bg-black text-white min-h-screen pt-28 pb-0 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="w-full aspect-[21/9] rounded-2xl overflow-hidden bg-neutral-950 border border-neutral-900 mb-24 relative select-none">
          <img
            src={project.imageUrl}
            alt={project.title}
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover grayscale contrast-[1.10] filter brightness-[0.85]"
          />
