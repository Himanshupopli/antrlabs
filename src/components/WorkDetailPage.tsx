...
import InnovestPage from "./InnovestPage";
import ZinohaPage from "./ZinohaPage";
import BisleriPage from "./BisleriPage";
import CrustAndKettlePage from "./CrustAndKettlePage";
import SukhamPage from "./SukhamPage";
import FuproPage from "./FuproPage";
          ...
          {meta.screens.map((scr, idx) => (
            ...
            >
              <img
                ...
                alt={scr.label}
                referrerPolicy="no-referrer"
                className="w-full h-full object-contain grayscale group-hover:grayscale-0 transition-all duration-700 ease-out brightness-95 group-hover:brightness-100"
              />
        ...
        <div className="max-w-3xl mx-auto relative z-10 flex flex-col items-center">
          ...
          <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-white bg-black/10 mb-8 shadow-xl">
            <img
              ...
              alt={meta.author}
              referrerPolicy="no-referrer"
              className="w-full h-full object-contain grayscale contrast-110 filter brightness-95"
            />
          </div>
